...
const translations = {
  ru: {
    ...
    themes: {
      ...
      ангельская_связь: 'Ангельская связь',
      баланс: 'Баланс',
      богатство: 'Богатство',
      видение: 'Видение',
      выравнивание: 'Выравнивание',
      гармония: 'Гармония',
      духовное_исцеление: 'Духовное исцеление',
      духовное_пробуждение: 'Духовное пробуждение',
      духовность: 'Духовность',
      жизненная_сила: 'Жизненная сила',
      ...
      рост: 'Рост',
      связь: 'Связь',
      связь_с_ангелами: 'Связь с ангелами',
      связь_с_природой: 'Связь с природой',
      сила: 'Сила',
      смелость: 'Смелость',
      ...
      фокус: 'Фокус',
      эмоции: 'Эмоции',
      эмоциональное_исцеление: 'Эмоциональное исцеление',
      эмоциональный_баланс: 'Эмоциональный баланс',
      эмпатия: 'Эмпатия',
      энергия: 'Энергия',
      ясность: 'Ясность',
    },
  ...
  en: {
    ...
    themes: {
      ...
      ангельская_связь: 'Angelic connection',
      баланс: 'Balance',
      богатство: 'Wealth',
      видение: 'Vision',
      выравнивание: 'Alignment',
      гармония: 'Harmony',
      духовное_исцеление: 'Spiritual healing',
      духовное_пробуждение: 'Spiritual awakening',
      духовность: 'Spirituality',
      жизненная_сила: 'Vitality',
      ...
      рост: 'Growth',
      связь: 'Connection',
      связь_с_ангелами: 'Connection with angels',
      связь_с_природой: 'Connection with nature',
      сила: 'Strength',
      смелость: 'Courage',
      ...
      фокус: 'Focus',
      эмоции: 'Emotions',
      эмоциональное_исцеление: 'Emotional healing',
      эмоциональный_баланс: 'Emotional balance',
      эмпатия: 'Empathy',
      энергия: 'Energy',
      ясность: 'Clarity',
    },
